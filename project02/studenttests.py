...
class TestSquaredLoss(unittest.TestCase):
    ...
    def test_length_less_1(self):
        ...
        # call the `squared_loss` function
        t.call("squared_loss")
        # generate the `assembly/TestSquared_loss_test_length_less_1.s` file and run it through venus
        t.execute(code=36)
...
class TestZeroOneLoss(unittest.TestCase):
    ...
    def test_length_less_1(self):
        ...
        # call the `squared_loss` function
        t.call("zero_one_loss")
        # generate the `assembly/TestZero_one_loss_test_length_less_1.s` file and run it through venus
        t.execute(code=36)
...
class TestInitializeZero(unittest.TestCase):
    def test_simple(self):
        ...
        # check that the register a0 contains the correct array
        # (hint: look at the check_array_pointer function in framework.py)
